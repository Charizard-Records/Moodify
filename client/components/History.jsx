                  ...
                  <a href="#" className="items-center block p-1 sm:flex  ">
                    ...
                    <div>
                      <div className="text-base font-normal">
                        ...
                        ${userHis.mood == 'Mood Booster' && 'text-orange-400'}
                        ${userHis.mood == 'Motivated' && 'text-pink-400'}
                        ${userHis.mood == 'Feeling blue' && 'text-sky-500'}
                        ${userHis.mood == 'Chill' && 'text-indigo-500'}
                        ${userHis.mood == 'Upbeat' && 'text-green-500'}
                        ${userHis.mood == 'Anger' && 'text-rose-600'}
                        `}>
                          {userHis.mood}
                        </span>
                      </div>
