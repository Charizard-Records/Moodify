...
const MoodHistory = () => {
  return (
    ...
    scrollbar-thin overflow-y-scroll max-h-screen text-white">
      ...
      <div className="p-2 mb-2 border border-gray-700 rounded-lg 
      bg-gradient-to-r from-black  via-gray-900 to-gray-800 ">
        ...
        <ol className="divide-y divider-gray-200 ">
          <li>
            <a
              href="#"
              className="items-center block p-1 sm:flex  "
            >
              <img
              ...
              <div >
                ...
                <div className="text-sm font-normal ">
                  I'm bursting with energy today, feeling like I could take on
                  the world! Every task feels invigorating, and I'm eager to
                  channel this vibrant, lively mood into all that I do.{" "}
                </div>
